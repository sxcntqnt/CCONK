            ...
            <components_1.MaxWidthWrapper>
                <components_1.AnimationContainer delay={0.1} className="w-full">
                    <div className="mx-auto flex max-w-lg flex-col items-center justify-center py-10">
                        <magic_badge_1.default>Secure</magic_badge_1.default>
                ...
                <components_1.AnimationContainer delay={0.2} className="w-full">
                    <div className="mx-auto flex w-full max-w-4xl py-10">
                        <image_1.default src="/assets/password-protection.svg" alt="Protect your links with a password" width={80} height={80} className="h-auto w-full"/>
                    </div>
                </components_1.AnimationContainer>
