...
const PaginationLink = ({ className, isActive, size = 'icon', children, ...props }) => (<link_1.default aria-current={isActive ? 'page' : undefined} className={(0, utils_1.cn)((0, button_1.buttonVariants)({
...
const PaginationPrevious = ({ className, size, ...props }) => (<PaginationLink aria-label="Go to previous page" size="default" className={(0, utils_1.cn)('gap-1 pl-2.5', className)} {...props}>
        <lucide_react_1.ChevronLeft className="h-4 w-4"/>
        <span>Previous</span>
    </PaginationLink>);
exports.PaginationPrevious = PaginationPrevious;
PaginationPrevious.displayName = 'PaginationPrevious';
const PaginationNext = ({ className, size, ...props }) => (<PaginationLink aria-label="Go to next page" size="default" className={(0, utils_1.cn)('gap-1 pr-2.5', className)} {...props}>
        <span>Next</span>
