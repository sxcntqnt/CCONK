...
const TripCard = ({ trip }) => {
    ...
    const handleMapLoad = () => {
        ...
        const departureCoords = [
            trip.originLongitude ?? 0,
            trip.originLatitude ?? 0,
        ];
        const arrivalCoords = [
      ...
      <div className="flex flex-col items-start justify-center w-full">
        <div className="flex flex-row items-center justify-between w-full">
          ...
          <div className="flex flex-col mx-4 gap-y-4 flex-1">
            <div className="flex flex-row items-center gap-x-2">
              ...
              <span className="text-base font-aeonik-medium truncate">
                {trip.departureCity}
              </span>
            </div>
        ...
        <div className="flex flex-col w-full mt-4 bg-gray-100 rounded-lg p-4">
          <div className="flex flex-row items-center justify-between mb-4">
            <span className="text-base font-aeonik-medium text-gray-500">
              Date & Time
            </span>
          ...
          <div className="flex flex-row items-center justify-between mb-4">
            ...
            <span className="text-base font-aeonik-bold">
              {driverName}
            </span>
          </div>
