...
exports.validCapacities = exports.matatuConfigs = void 0;
exports.validateCapacity = validateCapacity;
exports.matatuConfigs = {
    '14': {
        totalSeats: 14,
...
exports.validCapacities = Object.keys(exports.matatuConfigs);
function validateCapacity(capacity) {
    const capacityStr = String(capacity);
    return exports.validCapacities.includes(capacityStr) ? capacityStr : '14';
}
// Configuration validation
Object.entries(exports.matatuConfigs).forEach(([key, config]) => {
