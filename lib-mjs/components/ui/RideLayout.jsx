...
const RideLayout = ({ title, children }) => {
    ...
    return (<div className={`flex flex-col min-h-screen bg-gray-50 ${aeonik.variable}`}>
            <div className="relative flex flex-col bg-blue-500">
                ...
                <Map onMapLoad={handleMapLoad} onDrawCreate={handleDrawCreate} onDrawUpdate={handleDrawUpdate} onDrawDelete={handleDrawDelete} mapRef={mapRef} drawRef={drawRef}/>
            </div>
