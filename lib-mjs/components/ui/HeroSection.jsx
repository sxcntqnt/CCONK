...
export default function HeroSection({ user }) {
    return (<MaxWidthWrapper>
            <div className="flex flex-col items-center justify-center w-full text-center bg-[hsl(var(--background))] py-10">
                <AnimationContainer delay={0.1} className="flex flex-col items-center justify-center w-full text-center">
                    ...
                    <div className="mt-12 rounded-[var(--border-radius-lg)] border-[hsl(var(--border))] bg-[hsl(var(--background)/0.5)] p-2 backdrop-blur-sm">
                        <Image src="/assets/dashboard-dark.svg" alt="FLAM Dashboard showing live matatu tracking" width={1200} height={1200} quality={100} className="rounded-[var(--border-radius-md)]" onError={() => console.error('Failed to load dashboard image')}/>
                    </div>
                </AnimationContainer>
            </div>
        </MaxWidthWrapper>);
