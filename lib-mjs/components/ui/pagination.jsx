...
const PaginationLink = ({ className, isActive, size = 'icon', children, ...props }) => (<Link aria-current={isActive ? 'page' : undefined} className={cn(buttonVariants({
...
const PaginationPrevious = ({ className, size, ...props }) => (<PaginationLink aria-label="Go to previous page" size="default" className={cn('gap-1 pl-2.5', className)} {...props}>
        <ChevronLeft className="h-4 w-4"/>
        <span>Previous</span>
    </PaginationLink>);
PaginationPrevious.displayName = 'PaginationPrevious';
const PaginationNext = ({ className, size, ...props }) => (<PaginationLink aria-label="Go to next page" size="default" className={cn('gap-1 pr-2.5', className)} {...props}>
        <span>Next</span>
