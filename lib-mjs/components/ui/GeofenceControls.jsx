            ...
            <div className="border-t border-border pt-4">
                    ...
                    backgroundColor: geofence.color,
                                    ...
                                    <div className="flex-1">
                                        {editingName === geofence.id ? (<div className="flex items-center space-x-2">
                                                ...
                                                <Button variant="ghost" size="sm" onClick={() => handleSaveName(geofence.id)}>
                                                    Save
                                                </Button>
                                    ...
                                    {(editMode || activeGeofence === geofence.id) && (<div className="flex space-x-2">
                                            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => handleEditName(geofence)}>
                                                <PencilIcon size={14}/>
                                            </Button>
                                            <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" onClick={() => handleDeleteClick(geofence.id)}>
                                                <TrashIcon size={14}/>
                                            </Button>
                                        </div>)}
                                </div>
                ...
                <div className="mt-6">
                    ...
                    <div className="flex space-x-2">
                        <Button variant="outline" size="sm" className="text-sm" onClick={() => startDrawing('draw_rectangle')} disabled={!editMode}>
                            <PlusIcon size={14} className="mr-1"/>
                            Rectangle
                        </Button>
                        <Button variant="outline" size="sm" className="text-sm" onClick={() => startDrawing('draw_polygon')} disabled={!editMode}>
                            <PlusIcon size={14} className="mr-1"/>
                            Polygon
                        </Button>
                    </div>
