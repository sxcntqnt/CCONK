...
export const CARDS = [
    {
        ...
        background: (<Card className="absolute left-10 top-10 origin-top rounded-none rounded-tl-md border border-r-0 border-[hsl(var(--border))] transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_100%)] group-hover:scale-105">
                <CardHeader>
                ...
                <CardContent className="-mt-4">
                    ...
                    <Input type="text" placeholder="Enter route number or destination..." className="w-full focus-visible:ring-0 focus-visible:ring-transparent"/>
                </CardContent>
            </Card>),
    },
    {
        ...
        background: (<Command className="origin-to absolute right-10 top-10 w-[70%] translate-x-0 border border-[hsl(var(--border))] p-2 transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10">
    ...
    },
    {
        ...
        cta: 'Learn more',
        className: 'col-span-3 lg:col-span-1',
        background: (<Card className="absolute right-10 top-10 origin-top w-[70%] rounded-md border border-[hsl(var(--border))] transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:scale-105">
                <CardHeader>
    ...
    },
    {
        ...
        cta: 'Learn more',
        className: 'col-span-3 lg:col-span-2',
        background: (<Integrations className="absolute right-2 top-4 h-[300px] w-[600px] border-none pl-28 md:pl-0 transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105"/>),
    },
];
const BentoGrid = ({ children, className }) => {
    return (<div className={cn('grid w-full auto-rows-[22rem] grid-cols-3 gap-4 min-w-0', className)} aria-label="FLAM feature grid">
            {children}
        </div>);
};
const BentoCard = ({ name, className, background, Icon, description, href, cta, }) => (<div key={name} className={cn('group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-xl border border-[hsl(var(--border))/0.6] animate-wiggle', 'bg-[hsl(var(--card))] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]', className)}>
        <div>{background}</div>
        ...
        <div className={cn('absolute bottom-0 flex w-full translate-y-10 flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100')}>
