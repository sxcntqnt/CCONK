...
const TripCard = ({ trip }) => {
    ...
    return (<div className={`flex flex-row items-center justify-center bg-white rounded-lg shadow-sm border border-gray-200 mb-4 p-4 ${aeonik.variable}`}>
            <div className="flex flex-col items-start justify-center w-full">
                <div className="flex flex-row items-center justify-between w-full">
                    <div className="w-20 h-[90px] rounded-lg overflow-hidden">
                        <MapComponent onMapLoad={handleMapLoad} onDrawCreate={handleDrawCreate} onDrawUpdate={handleDrawUpdate} onDrawDelete={handleDrawDelete} mapRef={mapRef} drawRef={drawRef}/>
                    </div>
                    ...
                    <div className="flex flex-col mx-4 gap-y-4 flex-1">
                        ...
                        <div className="flex flex-row items-center gap-x-2">
                            <Image src={icons.point} alt="Destination icon" width={20} height={20} className="w-5 h-5"/>
