...
const InnerProviders = ({ children }) => {
    ...
    const [knockToken, setKnockToken] = React.useState(null);
    ...
    const commonProviders = (<ThemeProvider attribute="class" defaultTheme="dark" enableSystem={false} disableTransitionOnChange>
            <SidebarProvider>
    ...
    return (<KnockProvider apiKey={KNOCK_PUBLIC_API_KEY} userId={user.id} userToken={knockToken}>
            {commonProviders}
        </KnockProvider>);
};
