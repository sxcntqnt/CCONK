...
import { mapDriverAndBusToMarkerData } from '@/store';
...
export const getDriverAndBusMarkerData = async (driverId) => {
    try {
...
export const createTripReservation = async (userId, tripId, seatId) => {
    try {
...
export const getTripIdForDriver = async (driverId) => {
    try {
...
export const getUsersWithReservations = async (tripId) => {
    try {
...
export const getDriverData = async (clerkId) => {
    try {
...
export const getReservationCount = async (tripId) => {
    try {
...
export const handleArrival = async (tripId) => {
    try {
        const trip = await db.trip.findUnique({
            where: { id: tripId },
        });
