...
import { MPESA_BASE_URL } from '../../../src/utils/constants/mpesa-urls.mjs';
export async function initiateStkPush({ mpesa_number: phoneNumber, name, amount, }) {
    ...
    try {
        ...
        const response = await axios.post(`${MPESA_BASE_URL}/mpesa/stkpush/v1/processrequest`, paymentData, {
            headers: {
