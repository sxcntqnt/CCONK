'use server';
import { db } from '@/lib';
import { getTripIdForDriver, updateTripStatus, TripStatus, } from '@/utils';
...
export async function getActiveTrips({ driverId, page = 1, pageSize = 10, filters = {}, }) {
    try {
...
export async function getNotifications({ driverId, page = 1, pageSize = 10, filters = {}, }) {
    try {
...
export async function updateTripStatusAction({ tripId, driverId, status, destination, }) {
    try {
...
export async function ensureDriverHasTrip(driverId) {
    try {
        const tripResponse = await getTripIdForDriver(driverId);
