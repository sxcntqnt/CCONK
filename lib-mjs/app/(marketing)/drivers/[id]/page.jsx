...
import { useDriverStore, useBusStore, useReservationStore, mapDriverAndBusToMarkerData } from '@/store';
...
const useNotifications = (driverTitle) => {
    const notify = useCallback(async (status, destination) => {
...
const DriverProfile = ({ driverDetails }) => (<div className="flex flex-col items-center justify-center mt-10">
        <Image src={driverDetails.profileImageUrl} alt="Driver Profile" width={112} height={112} className="rounded-full"/>
...
const BusOccupancy = ({ progress, reservationCount, capacity, }) => (<div className="mt-5">
        ...
        <ProgressLoader progress={progress} height="12px" barColor="bg-gray-200" fillColor="bg-green-600" className="w-full"/>
