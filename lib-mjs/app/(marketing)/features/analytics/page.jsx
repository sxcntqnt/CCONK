            ...
            <MaxWidthWrapper>
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="mx-auto flex max-w-lg flex-col items-center justify-center py-10">
                        ...
                        <p className="mt-6 text-center text-base text-muted-foreground md:text-lg">
                            Gain deep insights into your link performance with real-time analytics. Track clicks, device
                            usage, and more to optimize your strategy.
                        </p>
                ...
                <AnimationContainer delay={0.2} className="w-full">
                    <div className="mx-auto flex w-full max-w-4xl py-10">
                        <Image src="/assets/analytics.svg" alt="Advanced analytics for your business" width={80} height={80} className="h-auto w-full"/>
                    </div>
                </AnimationContainer>
