...
export default async function OwnerDashboard() {
    ...
    return (<ClientOwnerDashboard user={user} trips={trips} buses={buses} drivers={drivers} reservations={reservations} incomeExpenses={incomeExpenses} geofences={geofences} reports={reports} users={users} role={role}/>);
}
