...
export default function NotificationsPage() {
    ...
    const { data: prismaNotifications = [], isLoading, error: prismaError, } = useQuery({
    ...
    return (<div className={cn('container mx-auto py-8 max-w-7xl px-4 sm:px-6 lg:px-8', 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 auto-rows-min')}>
            <div className="col-span-12 lg:col-span-8">
                <h1 className="text-3xl font-bold mb-6">Notifications</h1>
                {(role === ROLES.DRIVER || role === ROLES.OWNER) && (<Card className="mb-6">
                        <CardHeader>
                        ...
                        <CardContent>
                            <Form {...form}>
                                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                    <FormField control={form.control} name="destination" render={({ field }) => (<FormItem>
                ...
                <div className="flex justify-end mb-4">
                    <NotificationFeed badgeCountVisible={true} customRenderer={true} userRole={role}/>
                </div>
                ...
                return (<Card key={mappedNotif.id} className={cn('transition-all duration-200', role === ROLES.PASSENGER &&
                        'border-blue-500 bg-gradient-to-r from-blue-500/10 to-teal-500/10 hover:shadow-blue-500/20', role === ROLES.DRIVER &&
                        'border-purple-500 bg-gradient-to-r from-purple-500/10 to-red-500/10 hover:shadow-purple-500/20', role === ROLES.OWNER &&
                        ...
                        : 'Unknown time'}
                                    ...
                                    <CardContent>
                                        ...
                                        {role === ROLES.PASSENGER && mappedNotif.tripId && (<Button variant="outline" size="sm" className="mt-2" asChild>
