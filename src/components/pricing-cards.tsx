...
const PricingCards = () => {
    ...
    return (
        <Tabs defaultValue="monthly" className="flex w-full flex-col items-center justify-center">
            <TabsList>
            ...
            >
                {PLANS.map((plan) => (
                    ...
                    >
                        ...
                        >
                            <CardTitle
                                className={cn(plan.name !== 'Pro' && 'text-muted-foreground', 'text-lg font-medium')}
                            >
                                {plan.name}
                            </CardTitle>
                            ...
                            <h5 className="flex items-end text-3xl font-semibold">
                                ...
                                {plan.name !== 'Free' && (
                                    <motion.span
                                        ...
                                        className="ml-2 rounded-md bg-purple-500 px-2 py-0.5 text-sm font-medium text-foreground"
                                    >
                                        -12%
                                    </motion.span>
                                )}
