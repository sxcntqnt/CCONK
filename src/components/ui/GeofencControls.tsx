        ...
        <div className="w-full md:w-1/4 p-4 bg-background border-l border-border overflow-y-auto">
            <div className="mb-6">
                ...
                <p className="text-sm text-muted-foreground">
                    Create and manage your geofences. Draw on the map using the tools in the top right corner.
                </p>
            </div>
            ...
            <div className="border-t border-border pt-4">
                ...
                {geofences.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                        ...
                        {!searchQuery && (
                            <p className="text-sm mt-2">Use the drawing tools to create your first geofence</p>
                        )}
                    </div>
                ) : (
