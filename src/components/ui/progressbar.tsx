...
interface ProgressLoaderProps {
    ...
    height?: string; // Height of the progress bar (default: 8px)
    barColor?: string; // Background color of the empty bar (default: gray)
    fillColor?: string; // Color of the filled progress (default: green)
    ...
    return (
        <div className={`relative w-full ${className}`}>
            ...
            <div
                ...
                style={{ left: `calc(${clampedProgress}% - 24px)` }} // Adjust for car width
            >
                <svg
                    width="48"
                    height="24"
                ...
                >
                    ...
                    <g className="animate-flame">
                        <path
                            d="M8 12C8 10.5 6.5 9 4 9C1.5 9 0 10.5 0 12C0 13.5 1.5 15 4 15C6.5 15 8 13.5 8 12Z"
                            fill="#FF4500"
                        />
