      ...
      <div className="container mx-auto py-8">
        ...
        <Card className="w-full max-w-md mx-auto">
          ...
          <CardContent className="space-y-4">
            <p>You don’t have any active reservations yet. Reserve a seat to start tracking your trip and receiving notifications!</p>
            {buses.length > 0 ? (
              <div className="space-y-2">
                ...
                {buses.map((bus) => (
                  <div key={bus.id} className="flex justify-between items-center">
                    <span>{bus.licensePlate} (Capacity: {bus.capacity})</span>
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Suspense fallback={<Card><CardContent>Loading notifications...</CardContent></Card>}>
