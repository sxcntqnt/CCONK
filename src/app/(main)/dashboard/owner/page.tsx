    ...
    if (!user) {
        return (
            <div className="container mx-auto py-8">
                <p>Please sign in to access the owner dashboard.</p>
            </div>
        );
    }
