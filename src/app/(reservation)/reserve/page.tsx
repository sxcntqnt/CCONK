    ...
    <MaxWidthWrapper className="py-6">
      <LampContainer>
        <AnimationContainer>
          ...
          <MagicBadge className="mb-4">
            Book your ride in style!
          </MagicBadge>
        </AnimationContainer>
      </LampContainer>
      ...
      {selectedBusId && Object.keys(seatsForLayout).length > 0 && layout.length > 0 ? (
        <div className="mb-6">
          ...
          <p className="text-gray-300 text-center mt-1">
            Seats: {Object.keys(seatsForLayout).length}
          </p>
        </div>
      ) : (
...
const BusSelectionCard = ({
  ...
  <Card className="bg-gray-900 text-white border-none shadow-lg">
    ...
    <CardContent>
      <div className="mb-4">
        <label htmlFor="busSelect" className="text-sm text-gray-300">Select Bus</label>
        <select
          id="busSelect"
          value={selectedBusId || ''}
